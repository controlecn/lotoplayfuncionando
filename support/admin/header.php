...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="height:100%">
  <tr> 
	<td height="65" valign="top" class="bgHead">
		...
		<tr> 
			...
			<td align="right" valign="top">&nbsp;(Se você não e <?php echo stripslashes( $admin['name'] ) ?>, <a href="../index.php?action=logout&sid=<?php echo $sid ?>&l=<?php echo $l ?>">clique aqui
			</a>)<strong>&nbsp;&nbsp;|&nbsp;&nbsp;<a href="../index.php?action=logout&sid=<?php echo $sid ?>&l=<?php echo $l ?>">SAIR</a>&nbsp;&nbsp;</strong></td>
		</tr>
		</table>
	  </td>
  </tr>
  ...
  <tr> 
	...
	<center>
	<a href="index.php?sid=<?php echo $sid ?>&deptid=<?php echo $deptid ?>">Principal</a> |
	...
	<a href="index.php?sid=<?php echo $sid ?>&deptid=<?php echo $deptid ?>&action=edit_password">Preferências</a>
	</center>
	<br>
