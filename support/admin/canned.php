...
<!--
	...
	function check_command()
	{
		...
		{
			alert( "Escolhe um comando primeiro." ) ;
...
<tr> 
    <td width="100%" height="350" valign="top"> 
	  <p><span class="title">Operador: Respostas prontas</span><br>
		Respostas prontas. São um jeito simples de escrever mensagens que você
		frequentemente usa.</p>
	<table cellspacing=1 cellpadding=2 border=0 width="100%">
	  <tr> 
		<th align="left" nowrap>Referência</th>
	  ...
	  <tr> 
		...
		<tr>
			<td>Referência</td>
			<td><input name="name" type="text" style="width:100px" size="<?php echo $text_width ?>" maxlength="20" value="<?php echo stripslashes( $cannedinfo['name'] ) ?>"> <i>(Exemplo: LIBERADO)</i></td>
		</tr>
		<tr>
			<td colspan=2><span class="small">Código HTML não permitido.  Por favor, use <a href="JavaScript:open_help( 'commands' )">Comandos</a>.</td>
		</tr>
		<tr>
			<td>Mensagem</td>
			<td>
				<table cellspacing=0 cellpadding=0 border=0><tr><td><textarea name="message" cols="<?php echo $text_width_long ?>" rows=3 wrap="virtual"><?php echo preg_replace( "/\"/", "&quot;", stripslashes( $cannedinfo['message'] ) ) ?></textarea></td><td>&nbsp;</td><td><span class="small"><span class="hilight">%%user%%</span> - nome do cliente<br>
				<span class="hilight">%%operator%%</span> - nome do operador<br></td></tr></table>
			</td>
		</tr>
		<tr>
			<td>Departamento</td>
			<td><select name="deptid"><option value="0" <?php echo ( $cannedinfo['deptID'] == 0 ) ? "selected" : "" ?>>Todos meus departamentos</option>
			<?php
				for ( $c = 0; $c < count( $admin_departments ); ++$c )
				{
					$department = $admin_departments[$c] ;
...
<tr> 
    <td width="100%" height="350" valign="top"> 
	  <p><span class="title">Operador: Comandos prontos</span><br>
		Comandos prontos são jeito mais fácil de trabalhar com tarefas de código HTML.</p>
	  <table cellspacing=1 cellpadding=2 border=0 width="100%">
		<tr> 
		  <th align="left" nowrap>Referência</th>
		  <th align="left">Mensagem</th>
		...
		<tr> 
			<td>Referência</td>
			<td><input name="name" type="text" style="width:100px" size="<?php echo $text_width ?>" maxlength="20" value="<?php echo $cannedinfo['name'] ?>"> <i>(Exemplo: PUSH demo)</i></td>
		</tr>
		<tr>
