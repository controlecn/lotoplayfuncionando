...
<table width="100%" border="0" cellspacing="0" cellpadding="15">
  <tr> 
	<td width="100%" height="350" valign="top"> <p><span class="title">Preferências</span><br>
		Aqui você escolhe as suas preferências.  <?php echo ( isset( $success ) && $success ) ? "<font color=\"#29C029\"><big><b>Sucesso!</b></big></font>" : "" ?></p>
		<p><strong>Console timeout:</strong></p>
		<ul>
		<li> Por favor não mexa em este valor sem perguntar o técnico antes.</li>
		</ul>
		...
		<tr> 
			<td>Tempo de esperar o console <i>Offline</i> para fechar automaticamente:</td>
			<td> <font size=2> 
		...
		<tr> 
			<td>&nbsp; </td>
			<td><input type="button" value="Atualizar" class="mainButton" OnClick="do_submit_poll()"></td>
		</tr></form>
		</table>
		<br>
		...
		<strong>Tema da janela de Conversa:</strong><br>
		Escolha o seu tema preferida da janela de conversa. Isto não afeta a janela do cliente.
		<p>
		<form>
		...
		<p><strong>Mude a sua senha: <font color="#FF0000"><?php echo $error ?></font></strong>
		<table cellspacing=1 cellpadding=1 border=0>
		...
		<tr> 
			...
			<td><big><b>Você não pode mudar a sua senha.</b></big></td>
			<?php else: ?>
...
<table width="100%" border="0" cellspacing="15" cellpadding="0">
  <tr>
	...
	<p>
	<table cellspacing=0 cellpadding=2 border=0><tr><td valign="top"><span class="title"><font color="#29C029">Entre ONLINE &raquo; </font></span></td><td valign="top"> <a href="JavaScript:void(0)" OnClick="open_admin()"><img src="../images/extra/btn_launch.gif" width="275" height="28" border="0" alt=""></a></td></tr></table>
	<p>
	  Aqui você pode administrar as suas preferências e
	  ver conversas feitas.
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr> 
		<td class="hdash">&nbsp;</td>
	  </tr>
	...
	<form name=dept_select><p>
		Para ver todas as conversas <span class="basicTitle">escolhe o seu departamento</span>: 
	<?php
	...
	Página: <?php echo $page_string ?> </font><br>
	<table cellspacing=1 cellpadding=3 border=0 width="100%">
	  <tr> 
		...
		<th align="left" nowrap>Pergunta do cliente</td>
	...
	<form method="GET" action="index.php" name="form">
	  ...
	  <input type="hidden" name="deptid" value="<?php echo $deptid ?>">
		<tr> 
		  ...
		  <td><input type="button" OnClick="do_search()" class="mainButton" value="Enviar"></td>
		</tr></form>
	  </table>
		<!-- end search area -->
	  </p>
