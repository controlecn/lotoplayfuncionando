...
<!--
	...
	function do_submit()
	{
		if ( document.form.email.value == "" )
			alert( "E-mail não valido." ) ;
		else if ( document.form.email.value.indexOf("@") == -1 )
			alert( "E-mail não valido: (exemplo: alguem@empresa.com)" ) ;
		else
		{
			document.form.submitbutton.disabled = true ;
			document.form.submitbutton.value = "Um momento ..." ;
...
<div id="maintrans">
	...
	<fieldset>
		<dl>
			<dt>&nbsp;&nbsp;<label for="email">Enviar para</label></td>
		...
		<dl>
			<dt></dt><dd><input type="button" value="Enviar conversa" OnClick="do_submit()" class="button" name="submitbutton">  &nbsp;&nbsp; <input type="button" class="button" value="Imprimir conversa" OnClick="doprint()"></dd>
		</dl>
	</fieldset>
</div>
</form>
