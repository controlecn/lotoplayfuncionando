<?php
	...
	if ( $action == "login" )
	{
		...
		if ( !$aspinfo['active_status'] )
			$error = "Serviço não ativo.  Entre em contato com técnico." ;
		else
		{
...
?>
<?php if ( $wflag ): ?>
<html><head><title>Fechar</title></head><body> <!-- close_winapp --> </body></html>
<?php else: ?>
...
<tr>
	<td align="center">
		<span class="title">Um momento...<br>accessando a sua conta.
	</td>
</tr>
</table>
...
<?php elseif ( $l ): ?>
	...
	<input type="hidden" name="l" value="<?php echo $l ?>">
			<table cellspacing=1 cellpadding=3 border=0 width="300">
			  <tr align="center"> 
				<th colspan=2><span class="basicTitle">Login do Operador</span></th>
			</tr>
			  <tr> 
			  ...
			  <tr> 
				...
				<td nowrap> 
				  ...
				  <?php echo ( $winapp ) ? "Lembrar-me neste computador" : "Lembrar-me neste computador" ?></td>
			</tr>
			  <tr> 
				<td>&nbsp;</td>
				<td> 
...
<?php endif ; ?>
  ...
  <tr> 
	<td height="20" align="center" class="bgCopyright" style="height:20px">
		...
		v<?php echo $PHPLIVE_VERSION ?> &copy; Lotoplay.com
	</td>
  </tr>
</table>
</body>
