		...
		<div id="inputarea">
			<fieldset>
				<dl>
					...
					<br><br>
					<input type="button" value="Close Window" OnClick="parent.window.close()" class="button">
					<?php endif ; ?>
		...
		<div id="inputarea">
			<fieldset>
				...
				<dl>
					...
					<dd class="textbox"><textarea name="message" cols="25" rows="5" id="message" class="message2"><?php echo ( isset( $_SESSION['session_chat'][$sid]['question'] ) ) ? stripslashes( $_SESSION['session_chat'][$sid]['question'] ) : "" ; ?></textarea></dd>
