...
/*	{
		...
		{
			$image_path = "http://www.codedeli.com/pics/ad.gif" ;
	...
	if ( isset( $_GET['pagex'] ) ) { $page = urldecode( $_GET['pagex'] ) ; } else { $page = "" ; }
	...
	// check to see if domain is internal (such as reidobingo-net.umbler.net). if it is, skip the
