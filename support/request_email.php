...
var request_url = "<?php echo $BASE_URL ?>/request.php?l=<?php echo $_GET['l'] ?>&x=<?php echo $_GET['x'] ?>&deptid=<?php echo isset( $_GET['deptid'] ) ? $_GET['deptid'] : 0 ?>&pagex=Email+Signature" ;
