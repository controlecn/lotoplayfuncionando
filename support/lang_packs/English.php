...
$LANG['TITLE_SUPPORCHAT'] = "You are now speaking with Support" ;
...
$LANG['CHAT_REQUEST_TITLE'] = "Welcome to our Live Chat." ;
...
$LANG['CHAT_REQUEST_INPUTSCREENNAME'] = "Please input your name" ;
...
$LANG['CHAT_REQUEST_HOLD'] = "You may continue to hold or <a href=\"JavaScript:window.parent.message_box()\">leave a message</a>." ;
...
$LANG['MESSAGE_BOX_SENT'] = "Your message has been sent to:" ;
//orig: Items with (*) must be filled.
$LANG['MESSAGE_BOX_JS_A_ALLFIELDSSUP'] = "Please provide ALL fields." ;
...
//orig: to search our Knowlede Base
