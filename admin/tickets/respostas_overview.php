...
gui_header("Emails - Respostas prontas", "../");
...
<? } ?>
<a href="respostas_add.php" class="link">Adicionar...</a><br><br>
...
$sql = "SELECT id,nome FROM tickets_emails";
...
if ($result) {
  ...
  <tr>
	...
	<td bgcolor="<?=$color?>" height="23" align="center" valign="middle"><a href="respostas_edit.php?id=<?=$id?>"><img src="../images/icons/edit.gif" alt="<?=$lang_paymentforms_view_table_change?>" border="0"></a>&nbsp;&nbsp;<? if ($id!=1) { ?><a href="respostas_delete.php?id=<?=$id?>" onclick="return confirmDelete()"><img src="../images/icons/delete.gif" alt="<?=$lang_paymentforms_view_table_delete?>" border="0"></a><? } ?></td>
  </tr>
  <tr>
