...
<form method="post" action="send_message_upd.php">
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
	<td bgcolor="#d8e8d2" height="23" class="tabletext"><h2>Conteúdo do mensagem:</h2> Carregar resposta pronta: 
