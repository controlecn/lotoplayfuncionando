...
gui_tabletop(array($lang_accountsoverview_table_username, $lang_accountsoverview_table_name, $lang_accountsoverview_table_credits, $lang_accountsoverview_table_bonus), 1);

$result = mysql_query("SELECT id,fullname,username,email,ip FROM users WHERE `test` = '1'", $mysql_link);
