...
global $postcodefield, $postcode, $pid, $fpid, $users_who_read;
	...
	if(isset($_GET['nor'])){
		...
		@setcookie($globals['cookie_name'].'[threaded]', 0, (time()-(60*60*24*365)));
		
		unset($_COOKIE[$globals['cookie_name']]['threaded']);
	...
	if(isset($_GET['printtopic'])){
	...
	}elseif(isset($_GET['threaded']) || isset($_COOKIE[$globals['cookie_name']]['threaded'])){
		...
		@setcookie($globals['cookie_name'].'[threaded]', 1, (time()+(60*60*24*365)));
