	...
	if(isset($_POST['register'])){
		...
		////////////////////////////////	
			...
			if($globals['wel_email']){
				...
				$mail[0]['message'] = lang_vars($l['welcome_mail'], 
											array($username, $activation_code));
		...
		////////////////////////////////	
			...
			$mail[0]['message'] = lang_vars($l['activate_account_mail'], 
										array($username, $uid, $activation_code));
			//Pass it to the Mail sending function(Done Below)	
		...
		////////////////////////////////	
			...
			$mail[0]['message'] = lang_vars($l['approval_required_mail'], 
										array($username, $uid, $activation_code));
			//Pass it to the Mail sending function(Done Below)	
		...
		////////////////////////////////	
			...
			$mail[0]['message'] = lang_vars($l['coppa_mail'], 
										array($username, $uid, $activation_code));			
			//Pass it to the Mail sending function(Done Below)	
...
global $user, $conn, $dbtables, $logged_in, $globals, $l, $AEF_SESS, $theme, $error, $tree;
	...
	if(isset($_POST['resendact'])){
		...
		$mail[0]['message'] = lang_vars($l['resend_mail'], 
											array($row['id'], $row['activation_code']));
