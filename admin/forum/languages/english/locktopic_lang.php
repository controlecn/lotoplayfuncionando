...
$l['no_lock_permission_title'] = 'Access Denied';
$l['no_lock_permission'] = 'Sorry, you are not allowed to lock/unlock some of the topic(s) as you do not have the permissions to do so. If you have followed a valid link please contact us at <a href="mailto:'.$globals['board_email'].'">'.$globals['board_email'].'</a>.';

$l['unlock_error_title'] = 'Unlock Error';
$l['unlock_error'] = 'There were some errors in unlocking the topics(s). Please Contact the <a href="mailto:'.$globals['board_email'].'">Administrator</a>.';

$l['lock_error_title'] = 'Lock Error';
$l['lock_error'] = 'There were some errors in locking the topics(s). Please Contact the <a href="mailto:'.$globals['board_email'].'">Administrator</a>.';
