...
function startsetup(){
	...
	<br /><br />
	AEF 1.0.8 requires <b>PHP 4.1.0</b> or higher and <b>MySQL 3.23</b> or higher.
	<br /><br />
...
<td width="40%" class="rc">
<b>MySQL Host :</b><br />
<font class="exp">This is usually reidobingo-net.umbler.net.</font>
</td>
<td class="lc" align="left">
&nbsp;<input type="text" size="30"  name="server" value="<?php echo ( (isset($_POST['server'])) ? $_POST['server'] : 'reidobingo-net.umbler.net' );?>" />
</td>
</tr>
