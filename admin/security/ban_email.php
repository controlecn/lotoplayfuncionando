...
checkAccess(2);
gui_header("Ban Email", "../");

if ($_GET["cmd"]=="add") {

	SqlQuery("INSERT INTO fraud_banemail (email) VALUES ('".$_POST["email"]."')");

}

?>
<form method="post" action="ban_email.php?cmd=add">
...
$sql = "SELECT * FROM fraud_banemail";
...
if ($result) {
  ...
  <tr>
	...
	<td bgcolor="<?=$color?>" height="23" align="center"><a href="ban_email_delete.php?id=<?=$id?>"><img src="../images/icons/delete.gif" alt="Deletar" border="0"></a></td>
  </tr>
		<?
