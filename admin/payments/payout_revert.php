...
?>
<form id="ChangeForm" name="ChangeForm" action="payout_revert.php">
...
$sql = "Select * from transfers_payout WHERE status = 0 $timeperiod";
...
if ($result) {
  ...
  <tr>
	...
	<td bgcolor="<?=$color?>" height="23" class="tabletext"><?=$recebervia?></td>
