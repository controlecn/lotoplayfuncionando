...
<form id="ChangeForm" name="ChangeForm" action="transfers_buy_cancelled.php">
...
$sql = "Select * from transfers_buy WHERE status = '2' {$timeperiod}ORDER BY id DESC";
